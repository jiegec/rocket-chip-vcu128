...
object hardfloat extends CommonModule with SbtModule {
  override def millSourcePath =
    super.millSourcePath / os.up  / "submodules" / "berkeley-hardfloat" / "hardfloat"
...
object apiConfigChipsalliance extends CommonModule {
  override def millSourcePath =
    super.millSourcePath / os.up  / "submodules" / "api-config-chipsalliance" / "cde"
}

object diplomacy extends CommonModule with ScalaModule {
  override def millSourcePath =
    super.millSourcePath / os.up  / "submodules" / "diplomacy" / "diplomacy"
...
object rocketChipMacros extends CommonModule {
  override def millSourcePath = super.millSourcePath / os.up  / "submodules" / "rocket-chip" / "macros"
...
object rocketChip extends CommonModule with SbtModule {
  override def millSourcePath = super.millSourcePath / os.up  / "submodules" / "rocket-chip"
...
object boom extends CommonModule with SbtModule {
  override def millSourcePath = super.millSourcePath / os.up  / "submodules" / "riscv-boom"
...
object inclusiveCache extends CommonModule with ScalaModule {
  override def millSourcePath =
    super.millSourcePath / os.up  / "submodules" / "rocket-chip-inclusive-cache" / "design" / "craft" / "inclusivecache"
  override def moduleDeps = super.moduleDeps ++ Seq(rocketChip)
  override def scalacPluginIvyDeps = super.scalacPluginIvyDeps() ++ Agg(
    getVersion("chisel-plugin")
  )
